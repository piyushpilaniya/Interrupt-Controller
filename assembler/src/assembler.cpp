...
bool Assembler::isTwoOperand(Opcode opcode) {
    if(opcode == CMP || opcode == NOT || opcode == MOV || opcode == MOVZ)
        return true;
    return false;
}
...
void Assembler::readRegisterOperand(std::string &input, int &regIndex, bool &imm) {
    ...
    if(operString[0] == 'r' && operString[1] == 'a') {
        ...
        imm = false;
        return;
    }else if(operString[0]=='O' && operString[1]='l' && operString[2] == 'd' && operString[3]=='s' && operString[4]=='p'){
       regIndex= 1;
       imm = false;
       return;
    }else if(operString[0]=='O' && operString[1]='l' && operString[2] == 'd' && operString[3]=='p' && operString[4]=='c'){
       regIndex= 2;
       imm = false;
       return;
    }else if(operString[0]=='F' && operString[1]='l' && operString[2] == 'a' && operString[3]=='g' && operString[4]=='s'){
       regIndex= 3;
       imm = false;
       return;
    }else if(operString[0]=='O' && operString[1]='l' && operString[2] == 'd' && operString[3]=='F' && operString[4]=='l' && operString[5]=='a' && operString[6]=='g' && operString[7]=='s'){
       regIndex= 4;
       imm = false;
       return;
    }else if(operString[0]=='C' && operString[1]='a' && operString[2] == 'u' && operString[3]=='s' && operString[4]=='e' && operString[5]=='R' && operString[6]=='e' && operString[7]=='g'){
       regIndex= 5;
       imm = false;
       return;
